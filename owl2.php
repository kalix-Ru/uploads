...
function owlClear($text,$email){
    ...
    $text = str_replace("[-date2-]", date("d/m/Y", time()), $text);
    $text = str_replace("[-time-]", date("H:i:s", time()), $text);
    $text = str_replace("[-time2-]", date("H:i", time()), $text);
    $text = str_replace("[-timea-]", date("H:i:s A", time()), $text);
    $text = str_replace("[-timea2-]", date("H:i A", time()), $text);
    $text = str_replace("[-datetime-]", date("m/d/Y h:i", time()), $text);
    $text = str_replace("[-datetime2-]", date("d/m/Y h:i", time()), $text);
    $text = str_replace("[-datetimesecond-]", date("m/d/Y h:i:s", time()), $text);
    $text = str_replace("[-datetimesecond2-]", date("d/m/Y h:i:s", time()), $text);
    $text = str_replace("[-datetimea-]", date("m/d/Y h:i:s A", time()), $text);
    $text = str_replace("[-datetimea2-]", date("d/m/Y h:i:s A", time()), $text);
    $text = str_replace("[-email-]", $email, $text);
    $text = str_replace("[-emailuser-]", $emailuser, $text);
    $text = str_replace("[-randomletters-]", randString('abcdefghijklmnopqrstuvwxyz', 9, 10), $text);
    $text = str_replace("[-randomstring-]", randString('abcdefghijklmnopqrstuvwxyz0123456789', 8, 15), $text);
    $text = str_replace("[-randomnumber-]", randString('0123456789', 7, 8), $text);
...
<head>
  ...
  <title>Owl PHP*Mailer* <?php echo $owl['version']?></title>
...
<body>
 ...
 function startSending() {
  ...
  <div class="container col-lg-6">
    <h3>&#129417; Owl PHP*Mailer*<small> <?php echo $owl['version']?></small></h3>
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="form-group col-lg-6 ">
        ...
        <textarea placeholder="Random account will be used when sending a message.&#10;&#10;HOST|PORT|USER|PASS" name="smtpAccounts" id="smtpAccounts" class="form-control" rows="10" id="textArea"></textarea>
      </div>
    </div>
...
<button type="button"id="btnStop" class="btn btn-default btn-sm" onclick="stopSending();">Stop</button>
    ...
    <div class="col-lg-6"><br>
        ...
        <div id="well" class="well well">
            ...
            <h4>DATE & TIME</h4>
            <ul>
                <li>[-date-] : <b>Date</b> (<?php echo date("m/d/Y", time())?>)</li>
                <li>[-date2-] : <b>Date 2</b> (<?php echo date("d/m/Y", time())?>)</li>
                <li>[-time-] : <b>Time</b> (<?php echo date("H:i:s", time())?>)</li>
                <li>[-time2-] : <b>Time 2</b> (<?php echo date("H:i", time())?>)</li>
                <li>[-timea-] : <b>Time AM/PM</b> (<?php echo date("H:i:s A", time())?>)</li>
                <li>[-timea2-] : <b>Time 2 AM/PM</b> (<?php echo date("H:i A", time())?>)</li>
                <li>[-datetime-] : <b>Date and Time</b> (<?php echo date("m/d/Y h:i", time())?>)</li>
                <li>[-datetime2-] : <b>Date and Time 2</b> (<?php echo date("d/m/Y h:i", time())?>)</li>
                <li>[-datetimesecond-] : <b>Date and Time and Second</b> (<?php echo date("m/d/Y h:i:s", time())?>)</li>
                <li>[-datetimesecond2-] : <b>Date and Time and Second 2</b> (<?php echo date("d/m/Y h:i:s", time())?>)</li>
                <li>[-datetimea-] : <b>Date and Time AM/PM</b> (<?php echo date("m/d/Y h:i:s A", time())?>)</li>
                <li>[-datetimea2-] : <b>Date and Time 2 AM/PM</b> (<?php echo date("d/m/Y h:i:s A", time())?>)</li>
            </ul>
            <h4>RANDOM</h4>
            <ul>
