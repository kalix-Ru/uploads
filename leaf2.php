...
print '<div class="container col-lg-6">
    ...
    <div class="col-lg-6"><br>
        ...
        <div id="well" class="well well">
            ...
            <h4>DATE & TIME</h4>
            <ul>
                <li>[-date-] : <b>Date</b> ('.date("m/d/Y", time()).')</li>
                <li>[-date2-] : <b>Date 2</b> ('.date("d/m/Y", time()).')</li>
                <li>[-time-] : <b>Time</b> ('.date("H:i:s", time()).')</li>
                <li>[-time2-] : <b>Time 2</b> ('.date("H:i", time()).')</li>
                <li>[-timea-] : <b>Time AM/PM</b> ('.date("H:i:s A", time()).')</li>
                <li>[-timea2-] : <b>Time 2 AM/PM</b> ('.date("H:i A", time()).')</li>
                <li>[-datetime-] : <b>Date and Time</b> ('.date("m/d/Y h:i", time()).')</li>
                <li>[-datetime2-] : <b>Date and Time 2</b> ('.date("d/m/Y h:i", time()).')</li>
                <li>[-datetimesecond-] : <b>Date and Time and Second</b> ('.date("m/d/Y h:i:s", time()).')</li>
                <li>[-datetimesecond2-] : <b>Date and Time and Second 2</b> ('.date("d/m/Y h:i:s", time()).')</li>
                <li>[-datetimea-] : <b>Date and Time AM/PM</b> ('.date("m/d/Y h:i:s A", time()).')</li>
                <li>[-datetimea2-] : <b>Date and Time 2 AM/PM</b> ('.date("d/m/Y h:i:s A", time()).')</li>
            </ul>
            <h4>RANDOM</h4>
            <ul>
